...
public class ActivityHub extends AppCompatActivity implements BaseView, ActivityHubPresenter.Listener{
    ...
    public void setupViewpager () {
        ...
        setupViewPagerTab(viewPager, viewPagerTab, adapter);
    }

    private void setupViewPagerTab(ViewPager viewPagerP, SmartTabLayout viewPagerTab, FragmentPagerItemAdapter adapter) {
        ...
        viewPagerAnimation(viewPager);
    }

    private void viewPagerAnimation(ViewPager viewPager) {
        Animation fadeindown = AnimationUtils.loadAnimation(view.getContext(), R.anim.fadeintransition);
        viewPager.startAnimation(fadeindown);
    }
